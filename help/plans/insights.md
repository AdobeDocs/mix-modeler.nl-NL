...
In [!UICONTROL Plan insights] worden uw overzichtsinzichten gemaakt, met daarin de [!UICONTROL Model] , de [!UICONTROL Data range] en de [!UICONTROL Plan target] waarop het abonnement is gebaseerd.


Wanneer de inzichten worden gecreeerd, ziet u een overzicht van uw plan, dat bestaat uit:
...
- Een header die de [!UICONTROL Model] , de [!UICONTROL Data range] en de [!UICONTROL Plan target] weergeeft waarop het abonnement is gebaseerd.
   ...
   - Selecteer ![&#x200B; ChevronDown &#x200B;](/help/assets/icons/ChevronDown.svg) om meer details te tonen.**[!UICONTROL Show more]**
...
Met de matrix Kanaalsynergieën kunt u bepalen hoe marketingkanalen interageren om multiplicatieve effecten te creëren, die verder gaan dan hun individuele bijdragen.

![&#x200B; het kanaalsynergieën van het Plan &#x200B;](/help/assets/plan-channel-synergies.png)
...
Om een datumwaaier en bijbehorende doel metrisch te schrappen, uitgezochte ![&#x200B; dicht &#x200B;](/help/assets/icons/Close.svg).
         ...
         1. Selecteer **[!UICONTROL Next]** om terug te keren naar de sectie **[!UICONTROL Spend selection]** .
...
1. Wanneer u klaar bent met het bewerken van uw abonnement, selecteert u **[!UICONTROL Edit]** .
   ...
   Selecteer **[!UICONTROL All changes are final]** in het dialoogvenster **[!UICONTROL OK]** om de huidige uitgaventoewijzing en ROI- en inkomstenprognoses van het abonnement bij te werken. Selecteer **[!UICONTROL Cancel]** om de update van uw abonnement te annuleren.


- Selecteer **[!UICONTROL Cancel]** als u de abonnementsupdates wilt annuleren. Selecteer in het dialoogvenster **[!UICONTROL No work will be saved]** de optie **[!UICONTROL Cancel]** om verder te werken aan uw abonnement of selecteer **[!UICONTROL OK]** om terug te keren naar de interface Plans.
- Selecteer **[!UICONTROL Back]** om terug te gaan in de wizard.
