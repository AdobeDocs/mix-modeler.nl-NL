...
>abstract="De gegevens voor deze tabel worden alleen voor specifieke tijdsperioden gegenereerd.  De **[!UICONTROL As of]** -datum geeft aan wanneer de gegevens zijn gegenereerd en is gebaseerd op gegevens van een opgegeven datum tot een jaar terug."
