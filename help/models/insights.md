...
* [Kanaalsynergie](#channel-synergy)
...
Op het tabblad **[!UICONTROL Channel synergy]** kunt u met de **[!UICONTROL Channel synergies]** -visualisatie bepalen hoe marketingkanalen interageren om multiplicatieve effecten te maken, die verder gaan dan de afzonderlijke bijdragen.
...
![ het kanaalsynergieën van het Plan ](/help/assets/model-channel-synergies.png)
...
>abstract="Deze visualisatie laat een uitsplitsing zien van toegewezen omzettingen naar positie van het aanraakpunt en aanraakpunt over alle omzettingspaden. De visualisatie vergelijkt of een aanraakpunt op een positie beter bijdraagt dan die van resterende posities en andere aanraakpunten op een positie. De som van de procentuele bijdrage voor een toewijzingsmodel voor alle aanraakpunten en posities zou gelijk zijn aan 100. De posities beginner, invloedster en afwerker worden als volgt gedefinieerd:<ul><li>**Aanzet**: Wijst erop of aanraakpunt de eerste aanraking in een omzettingsweg is.</li><li>**Speler**: Wijst erop of touchpoint noch de eerste noch de laatste aanraking die aan omzetting leidt is.</li><li>**dichtbij**: Wijst erop of het aanraakpunt de laatste aanraking vóór omzetting is.</li></ul>"
...
>abstract="De efficiëntiemaatstaf die door het algoritmische attributiemodel wordt gegenereerd, geeft het relatieve belang aan van een aanraakpunt voor de conversie onafhankelijk van het aanraakpuntvolume. Dit wordt gemeten op een schaal van 1 tot 5. Het hogere aanraakpuntvolume garandeert geen hogere efficiëntiemaatstaf."


>[!CONTEXTUALHELP]
>id="models_diagnostics_totalvolume"
>title="Totaal volume"
>abstract="Het totale volume is het totale aantal keren dat een aanraakpunt door een gebruiker is aangeraakt en omvat alle aanraakpunten die op een pad worden weergegeven dat een conversie mogelijk maakt, en paden die niet tot conversie leiden."
