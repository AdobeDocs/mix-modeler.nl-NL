...
1. Selecteer ![&#x200B; FileData &#x200B;](/help/assets/icons2/FileData.svg) **[!UICONTROL Models]** van het linkerspoor.
...
1. U ziet een tabel met de huidige modellen.
   ...
   | **[!UICONTROL Run]** frequentie | De lopende frequentie van opleiding het model. |
