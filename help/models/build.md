...
1. In de sectie **[!UICONTROL Prior knowledge]** :
   ...
   1. Geef met de kolom **[!UICONTROL Name]** bijdragepercentages op voor elk van de kanalen die onder **[!UICONTROL Contribution proportion]** worden vermeld.
...
* Selecteer **[!UICONTROL Finish]** om de modelconfiguratie te voltooien.
   ...
   * Selecteer **[!UICONTROL Create instance?]** in het dialoogvenster **[!UICONTROL Ok]** om de eerste reeks training en scoring direct te starten. Uw model is vermeld met status ![ StatusOrange ](/help/assets/icons/StatusOrange.svg) **[!UICONTROL Awaiting training]**.
