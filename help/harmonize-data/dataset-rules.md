...
| **[!UICONTROL Schema]** | Het schema waaraan de dataset voldoet. U kunt de schemanaam snel selecteren om het schema in een nieuw lusje in de schemaredacteur in ![&#128279;](/help/assets/icons/Schemas.svg) Schema [&#x200B; Schema&#39;s &#x200B;](../ingest-data/schemas.md) te openen. |
...
1. Selecteer **[!UICONTROL Save]** om de voorkeuren voor gegevenssamenvoeging op te slaan. De gegevens worden opnieuw gesynchroniseerd. <br/>Selecteer **[!UICONTROL Cancel]** om te annuleren.
