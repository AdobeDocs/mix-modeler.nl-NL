...
1. Klikken **Een bewerking voorstellen** en dient een trekkingsverzoek (PR) met uw veranderingen in UI GitHub voor te leggen.
   ...
   Zie het algemene gedeelte [Handleiding Adobe Docs-contributor](https://experienceleague.adobe.com/docs/contributor/contributor-guide/introduction.html?lang=nl) voor meer informatie .
